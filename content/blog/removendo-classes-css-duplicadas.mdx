...
A dica que vou dar é pra quem usa o [VSCode](https://code.visualstudio.com/) já que ele tem uma extensão que vai nos ajudar muito. O nome dela é [DupChecker](https://marketplace.visualstudio.com/items?itemName=jianbingfang.dupchecker).
